...
<div class="row">
    <div class="col-12 form-area">
        <div class="col-md-8">
            <div class="card">
                <form class="form-horizontal" action="{{ route('notice.update') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <h4 class="card-title">
                            {{ $edit }}
                            <a href="{{ route('notice.index') }}" class="btn btn-sm btn-info float-end">
                                <i class="fa fa-eye"></i> All Notices
                            </a>
                        </h4>

                        <div class="form-group row">
                            <label class="col-md-3" for="name">Notice Name <span class="text-danger">*</span></label>
                            <div class="col-md-9">
