...
<div class="row">
    <div class="col-12 form-area">
        <div class="col-md-8">
            <div class="card">
                <form class="form-horizontal" action="{{ route('free-shipping-limit.update') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <h4 class="card-title">
                            {{ $edit }}
                        ...
                        <div class="form-group row">
                            <label class="col-md-3" for="amount">Limit Amount <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input type="text" name="amount" id="amount" class="form-control" value="{{ $info->amount }}" required>
                                @error('amount')
